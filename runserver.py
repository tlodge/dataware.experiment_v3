...
execution.ExecutionRequest.create_table(fail_silently=True)
execution.ExecutionResponse.create_table(fail_silently=True)
...
admin.register(execution.ExecutionResponse, execution.ExecutionResponseAdmin)
admin.register(execution.ExecutionRequest, execution.ExecutionRequestAdmin)
